...
ActiveRecord::Schema.define(version: 20161207104400) do
  ...
  add_index "spree_loyalty_points_transactions", ["source_type", "source_id"], name: "by_source", using: :btree
  add_index "spree_loyalty_points_transactions", ["type"], name: "index_spree_loyalty_points_transactions_on_type", using: :btree
  add_index "spree_loyalty_points_transactions", ["user_id"], name: "index_spree_loyalty_points_transactions_on_user_id", using: :btree
