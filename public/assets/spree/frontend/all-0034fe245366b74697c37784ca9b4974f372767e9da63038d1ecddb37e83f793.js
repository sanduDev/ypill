...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=ef687fce8174d0cbe9d0)
 * Config saved to config.json and https://gist.github.com/ef687fce8174d0cbe9d0
 */
...
$(document).ready(function(e){
  ...
  var crouselp = 	$(".carousel.slide .carousel-caption p").each(function(){
  		var ptag = $(this).html().replace(/ /g,'')
  		if (ptag.length < 2) {
  			$(this).remove();
  		}
  })
...
function toggleclass(tmobj, container){

  if($(tmobj).hasClass("open")) { //alert("yes")


    $(tmobj).removeClass("open");
    $(tmobj).addClass("closed");

   /* $(".toxoteggler-"+container).removeClass("open");
    $(".toxoteggler-"+container).addClass("closed");*/

     $(".toxoteggler-"+container).hide(250);
   

  }else{ //alert("no")
    $(tmobj).addClass("open");
    $(tmobj).removeClass("closed");

   /* $(".toxoteggler-"+container).addClass("open");
    $(".toxoteggler-"+container).removeClass("closed");*/

    $(".toxoteggler-"+container).show(250);
  } 
...
$(document).ready(function(){
      ...
      $("#product-thumbnails li a").hover(function(){

        var url = $(this).attr("href")

        if(typeof(url)!="undefined"){
          $("#product-images #main-image img").attr("src",url);
        }
      ...
      $("#prod-cont-tabs li").click(function(){

           $("#prod-cont-tabs li").removeClass("active");
           $(this).addClass("active");

           var tid = $(this).data("tab");

          $(".text-div .tabing").hide(100);
          $(".text-div .tabing").hide(100);
      ...
      $("a.trigger-wishlist").click(function(){

        $("form#new_wished_product").submit();
        return false;
      })
